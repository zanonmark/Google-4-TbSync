...
(function (exports) {
  ...
  async function observeTbSyncInitialized(aSubject, aTopic, aData) {
    try {
      ...
      if (TbSync.enabled) {
        const googleExtension = ExtensionParent.GlobalManager.getExtension(
          "google-4-tbsync@marcozanon.com"
        );
        console.log(`Registering GOOGLE provider v${googleExtension.manifest.version} with TbSync v${tbsyncExtension.manifest.version}`);
        await TbSync.providers.loadProvider(googleExtension, "google", "chrome://google-4-tbsync/content/provider.js");
      }
    } catch (e) {
  ...
  var Google4TbSync = class extends ExtensionCommon.ExtensionAPI {
  ...
  exports.Google4TbSync = Google4TbSync;
})(this);
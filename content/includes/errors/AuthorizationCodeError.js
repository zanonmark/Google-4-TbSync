...
class AuthorizationCodeError extends Error { // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error
    ...
    constructor(...args) {
        ...
        if (Error.captureStackTrace) {
            Error.captureStackTrace(this, AuthorizationCodeError);
        }
